  ...
  return (
    <div className="flex flex-col min-h-screen">
       ...
       <section className="w-full bg-white border-b border-black/10">
         <div className="container mx-auto px-6 lg:px-8 max-w-[1400px] py-16 md:py-24 lg:py-32">
           <div className="flex flex-col gap-6 md:gap-10 max-w-4xl">
              {/* Main H1 - Primary USP */}
              <h1 className="font-serif text-4xl leading-[1.2] sm:text-5xl md:text-6xl lg:text-7xl tracking-tight text-black">
                Słońce Południa w Twoim domu. Autorskie plakaty do druku.
              </h1>

              {/* H2 Subheading - Story & Differentiation */}
              <h2 className="font-sans text-lg md:text-xl leading-relaxed text-zinc-700">
              ...
              <div className="pt-2 w-full md:w-auto flex flex-col gap-3">
                <Button 
                  ...
                  className="rounded-none px-4 sm:px-6 md:px-8 py-5 sm:py-6 md:py-7 uppercase tracking-[0.1em] sm:tracking-[0.15em] font-semibold text-[11px] sm:text-xs md:text-sm flex items-center justify-center sm:justify-start gap-2 sm:gap-3 group bg-black text-white hover:bg-zinc-900 w-full sm:w-fit"
                >
                ...
                <p className="font-sans text-[10px] sm:text-xs md:text-sm text-zinc-600">
       ...
       <section className="container mx-auto px-6 lg:px-8 max-w-[1400px] py-20 md:py-32 border-t border-black/10">
         {/* Section Heading */}
         <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-black mb-10 md:mb-14">
         ...
         <div className="max-w-3xl">
           ...
           <div className="mb-8 md:mb-10 border-l-2 border-black/20 pl-6 md:pl-8">
             <p className="font-sans text-base md:text-lg leading-relaxed text-zinc-700 italic">
           ...
           {/* Main narrative */}
           <p className="font-sans text-base md:text-lg leading-relaxed text-zinc-700 mb-6">
        ...
        <section className="container mx-auto px-6 lg:px-8 max-w-[1400px] py-20 md:py-32 border-t border-black/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
            ...
            <div className="flex flex-col gap-4">
              ...
              <h3 className="font-sans text-lg md:text-xl font-semibold text-black">
                Wybierz swój klimat
              </h3>
        ...
        <section id="products-section" className="container mx-auto px-6 lg:px-8 max-w-[1400px] py-20 md:py-32 border-t border-black/10">
          <div className="mb-12 md:mb-16">
            ...
            <p className="font-sans text-xs tracking-[0.2em] uppercase text-zinc-600 mb-4 md:mb-6">
              Edycja limitowana • Kolekcja Śródziemnomorska MVP
            </p>

            {/* Main Heading */}
            <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl mb-6 md:mb-8 text-black">
              Wybierz swój kadr i pobierz plakat na ścianę do druku
            </h2>

            {/* Description */}
            <p className="font-sans text-base md:text-lg leading-relaxed text-zinc-700 max-w-3xl">
       ...
       <section className="container mx-auto px-6 lg:px-8 max-w-[1400px] py-16 md:py-20 border-t border-black/10">
         <div className="max-w-4xl">
           {/* Heading */}
           <h2 className="font-serif text-2xl md:text-3xl text-black mb-6 md:mb-8">
             Co dokładnie otrzymujesz po zakupie?
           </h2>

           {/* Main Description */}
           <div className="mb-8 md:mb-10">
              <p className="font-sans text-base md:text-lg leading-relaxed text-zinc-700 mb-4">
             ...
             <p className="font-sans text-base md:text-lg leading-relaxed text-zinc-700">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
             ...
             <div className="flex flex-col gap-3">
               <div className="flex items-center gap-3">
                 ...
                 <h3 className="font-sans font-semibold text-black text-sm md:text-base">
                   Dostawa w 2 minuty
                 </h3>
               </div>
               <p className="font-sans text-xs md:text-sm text-zinc-600 ml-8">
