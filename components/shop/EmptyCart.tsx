...
export function EmptyCart() {
  ...
  return (
    <div className="text-center py-12 px-4">
      ...
      <Button 
        className="mb-12 rounded-none bg-black text-white hover:bg-zinc-800 uppercase tracking-widest text-xs py-6"
        onClick={() => window.location.href = '/'}
      >
        ODKRYJ KOLEKCJĘ
      </Button>

      <h4 className="text-sm font-semibold mb-4 text-left">Sprawdź nasze najpopularniejsze plakaty:</h4>
      ...
      <div className="grid grid-cols-1 gap-4 text-xs text-zinc-500 border-t border-black/10 pt-8 text-left">
